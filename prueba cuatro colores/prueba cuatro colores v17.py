#v17
#Se ordenan solo los cruces automaticamente
#El carro completa la ruta de forma medio automatica
#Identifica los demas carros y vladi se para si no puede avanzar
#Transmite las ordenes por comunicacion serial, falta probar si el 255 funciona
#Hace falta medir en el lab las distancias a los que se deben ver
#los obstaculos y cambiar el tamano de lado para que se vea las
#paradas dentro del cruce
...
#Envia por serial, falta meterle el 255 en algun lado
def enviar(comando):
...
while(1):
    ...
    if not HSV:
        ...
        #Calculo de ruta, la posicion de vladi se ve en la parada antes
        #del cruce, que es cuando espera por una orden, la direccion se
        #puede ver dependiendo de en cual parada se detiene
        if meta != (-1,-1) and vladi != (-1,-1):
