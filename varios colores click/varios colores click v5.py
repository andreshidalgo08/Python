...
class filtro:
    ...
    def __init__(self, color, centro = [0, 0], danger = False, vlad = False, pos = (0,0)):
        self.vladi = vlad
        self.color = color
...
while(1):
    ...
    #Dibujar los cruces, probar esto
    if len(pxcruces) > 0:
        for cr in pxcruces:
    ...
    if not HSV:
        ...
        #UDRL 77, 97, 107, 117, cambiar la distancia para ver si tengo algo cerca
        ...
        for fil in filtros[1:]:
            ...
            elif (fil.centro[0] > px1[0] - 180 and fil.centro[0] < px1[0] - 120
                  and fil.centro[1] > px1[1] - rad and fil.centro[1] < px1[1] + rad):
                print str(filtros.index(fil)) + 'Izquierda'

            elif (fil.centro[0] > px1[0] - rad and fil.centro[0] < px1[0] + rad
                  and fil.centro[1] > px1[1] - 150 and fil.centro[1] < px1[1] - 90):
                print str(filtros.index(fil)) + 'Arriba'

            elif (fil.centro[0] > px1[0] - rad and fil.centro[0] < px1[0] + rad
                  and fil.centro[1] > px1[1] + 90 and fil.centro[1] < px1[1] + 150):
